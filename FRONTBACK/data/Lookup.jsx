...
export default {
  ...
  SIGNIN_HEADING: "Continue With Sparky",
  SIGNIN_SUBHEADING:
    "To use Sparky-Love, you must log into an existing account or create one.",
  SIGNIn_AGREEMENT_TEXT:
    "By using Sparky, you agree to the collection of usage data for analytics.",
